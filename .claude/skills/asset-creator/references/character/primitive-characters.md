...
2. **Emotion?** → affects face only (see [emotions.md](./references/characters/emotions.md))
...
2. **Eye blinking animation** - All characters must include the clipPath-based eye blink (see [emotions.md](./references/characters/emotions.md))
...
### Proportions (Ratios to Body Size)
Use these ratios to maintain proportions at any scale. `B` = body width/height.
...
## Emotions
For character emotions and expressions, see [emotions.md](./references/characters/emotions.md).